...
%   LOGISTICREGRESSION(X_orig, y, num_iters, alpha) X_orig should have an intercept term
...
if num_labels < 3
    ...
    [theta, J, exit_flag] = ...
            fminunc(@(t)(computeCost(t, X, y, regOn, lambda)), theta, options);
    ...
    for i = 1:num_labels
        ...
        [theta_temp J_temp] = ...
            fmincg (@(t)(computeCost(t, X, (y == i), regOn, lambda)), ...
                    theta_init, options);
